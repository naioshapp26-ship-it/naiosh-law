  ...
  return (
    <AppShell role={user.role} name={user.name}>
      <div style={{ maxWidth: 1200 }}>
        ...
        >
          {kpis.map((k) => (
            <div key={k.label} className="card-white" style={{ padding: "1.35rem 1.5rem" }}>
              <div
                style={{
                  display: "flex",
              ...
              <div style={{ fontSize: "2rem", fontWeight: 900, color: "#0a0a12", lineHeight: 1 }}>
                {k.value}
              </div>
        ...
        >
          <div className="card-white" style={{ padding: "1.5rem" }}>
            ...
            >
              <h2 style={{ fontSize: "0.95rem", fontWeight: 800, color: "#0a0a12" }}>الجلسات القادمة</h2>
              <Link href="/app/modules/court-sessions" style={{ fontSize: "0.75rem", color: "#c3152a", fontWeight: 600 }}>
                عرض الكل ←
              </Link>
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: "0.85rem" }}>
              {upcomingSessions.map((session) => (
                ...
                >
                  ...
                  >
                    <p style={{ fontSize: "0.82rem", fontWeight: 700, color: "#0a0a12" }}>{session.case}</p>
                    <span
                      style={{
                        background:
                          session.status === "قريبة"
                            ? "rgba(195,21,42,0.1)"
                            : "rgba(100,116,139,0.1)",
                        color: session.status === "قريبة" ? "#c3152a" : "#64748b",
                        borderRadius: "6px",
          ...
          <div className="card-white" style={{ padding: "1.5rem" }}>
            ...
            >
              <h2 style={{ fontSize: "0.95rem", fontWeight: 800, color: "#0a0a12" }}>المهام اليومية</h2>
              <span
                style={{
                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                          ...
                          style={{
                            background:
                              task.priority === "عاجل"
                                ? "rgba(239,68,68,0.1)"
                                : "rgba(100,116,139,0.1)",
                            color: task.priority === "عاجل" ? "#ef4444" : "#64748b",
                            borderRadius: "5px",
                        ...
                        <span style={{ fontSize: "0.68rem", color: "#94a3b8" }}>{task.due}</span>
                      </div>
                    </div>
                  </label>
                );
        ...
        <div className="card-white" style={{ padding: "1.5rem" }}>
          ...
          >
            <h2 style={{ fontSize: "0.95rem", fontWeight: 800, color: "#0a0a12" }}>الوحدات التشغيلية</h2>
            <span style={{ fontSize: "0.75rem", color: "#64748b" }}>{visibleModules.length} وحدة متاحة</span>
          </div>
          <div
