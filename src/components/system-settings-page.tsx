    ...
    <div className="ss-page">
              ...
              >
                <div className="upload-zone">
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                    <label className="ss-label" htmlFor="hero-img-file">ملف الصورة (PNG / JPG / WEBP)</label>
                    <input
                      id="hero-img-file"
                      ref={heroImgFileRef}
                      type="file"
                      ...
                      className="ss-input"
                    />
                    <label className="ss-label" htmlFor="hero-img-caption">عنوان / وصف (اختياري)</label>
                    <input
                      id="hero-img-caption"
                      ref={heroImgCaptionRef}
                      type="text"
                      maxLength={200}
                      placeholder="اكتب عنوانًا أو وصفًا للصورة"
                      className="ss-input"
                    />
                  </div>
                ...
                <div className="upload-zone upload-zone-video">
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                    <label className="ss-label" htmlFor="hero-vid-file">ملف الفيديو (MP4 / WEBM / MOV)</label>
                    <input
                      id="hero-vid-file"
                      ref={heroVidFileRef}
                      type="file"
                      ...
                      className="ss-input"
                    />
                    <label className="ss-label" htmlFor="hero-vid-caption">عنوان / وصف (اختياري)</label>
                    <input
                      id="hero-vid-caption"
                      ref={heroVidCaptionRef}
                      type="text"
                      maxLength={200}
                      placeholder="اكتب عنوانًا أو وصفًا للفيديو"
                      className="ss-input"
                    />
                  </div>
                  <p style={{ fontSize: "0.75rem", color: "#94a3b8", margin: "0.375rem 0 0.75rem" }}>
                  ...
                  orderedSections.map((section) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          <label style={{ display: "block" }}>
                            <span className="ss-label-xs">صنف الأيقونة (مثال: fas fa-gavel)</span>
                            <input
                              type="text"
                              className="ss-input"
      ...
      >
        ...
        <span style={{ fontSize: "0.875rem", color: "#64748b", display: "inline-flex", alignItems: "center", gap: "0.375rem" }}>
          ...
          سيتم تطبيق جميع التغييرات دفعة واحدة
        </span>
        <button
          type="button"
          onClick={() => void save()}
