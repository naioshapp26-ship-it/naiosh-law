...
const roleMeta: Record<UserRole, { label: string; description: string; icon: string }> = {
  ...
  industrial_agent: { label: "وكيل صناعي", description: "إدارة الاعتمادات والحوكمة", icon: "✅" },
  lawyer: { label: "محامٍ", description: "إدارة القضايا والموكلين", icon: "⚖️" },
  consultant: { label: "مستشار", description: "إدارة الاستشارات القانونية", icon: "💬" },
  judge: { label: "قاضٍ", description: "عرض الجلسات والمستندات", icon: "🏛️" },
  employee: { label: "موظف", description: "تشغيل ومتابعة الأعمال", icon: "👥" },
