...
export function StatsRow({ cards }: Props) {
  ...
  return (
    <>
      ...
      <style>{`
        @media (max-width: 1100px) { .kpi-row-grid { grid-template-columns: repeat(2,1fr) !important; } }
        @media (max-width: 520px) { .kpi-row-grid { grid-template-columns: 1fr !important; } }
      `}</style>
    </>
  );
}
