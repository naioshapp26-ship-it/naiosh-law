...
export const modules: LegalModule[] = [
  ...
  { slug: "integrations", title: "التكاملات الخارجية", subtitle: "ربط النظام بأنظمة خارجية", screens: ["واجهات API", "Webhooks", "حالة التكامل"], functions: ["توليد API key", "سجل الاستدعاءات"], workflow: ["تعريف تكامل", "اختبار اتصال", "تفعيل"], relations: ["كل الوحدات"], dbTables: ["integrations", "integration_logs"], permissions: basePermissions },
