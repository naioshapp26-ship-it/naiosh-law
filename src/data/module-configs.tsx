...
export const moduleConfigs: ModuleConfig[] = [
  ...
  /* 1. CASE MANAGEMENT */
  {
    ...
    formFields: [
      ...
      { key: "type",     label: "نوع القضية",  type: "select", options: ["جنائي","مدني","تجاري","عمالي","أحوال شخصية","إداري","عقاري","ملكية فكرية","إفلاس","جمركي","تأمين"] },
      ...
      {
        key: "attachments",
        label: "شواهد وملفات القضية (مستند · صورة · فيديو)",
        type: "files",
      },
    ],
  },
