...
- Production deployments must set `NAIOSH_SESSION_SECRET`, `AUTH_SECRET`, or `NEXTAUTH_SECRET` for private session signing. Preview/demo deployments can explicitly opt in to the shared fallback with `NAIOSH_ALLOW_DEMO_SESSION_SECRET=true`.
