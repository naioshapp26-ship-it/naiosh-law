  ...
  await prisma.legalArticle.createMany({
    data: [
      ...
      },
      {
        ...
        summary: "مقارنة بين أنظمة التحكيم المحلية والمراكز الدولية وقواعد التحكيم العالمية.",
    ...
    data: [
      {
        ...
        category: "خصوصية",
        description: "تنظم جمع وتخزين ومعالجة بيانات الموكلين وفقاً للتشريعات المعمول بها.",
        version: "2.1",
        status: "ساري",
